...
abstract class BaseRepository implements IBaseRepository
{
    ...
    //pk_name es el nombre columna clave primaria
    protected string $pk_name;
    protected PDO $conn;
    //nombre de la clase que vamos a usar
    protected string $class_name;

    //columna por la que queremos oredenar por defecto
    ...
    public function delete($id): bool
    {
        ...
        //podemos usar return $resultado siempre y cuando lo unicialicemos al inciio del try a false;
    }
