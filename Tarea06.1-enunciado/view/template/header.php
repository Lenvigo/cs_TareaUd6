		...
		<header class="mb-5">
			...
			?>
				<div class="d-flex  justify-content-end  align-items-center">
					...
					<!-- . Modifica la vista header.php para que el botón cerrar sesión esté dentro de un formulario que invoque el método logout del controlador UsuarioController con el método HTTP POST -->	
